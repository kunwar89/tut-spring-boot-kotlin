...
High level objectives are:
	...
	. Use TDD to develop all functionality (i.e. red-green-commit-refactor-commit)
	. Currently with the following dependencies:
		- Spring Web
		- Mustache
		- Spring Data JPA
		- H2 Database (Stretch: MySQL , PostgreSQL)
		- Spring Boot DevTools
	. Add a UI (JavaScript SPA or simple HTML)
	. Support EDD in your UI with RabbitMQ and/or Websockets
...
As a USER, I should be able to create and see many TODO lists
As a USER, I should be able to name my TODO list so I can manage them more easily
As a USER, I should be able to share my TODO list with another GUEST who can view only that list
As a USER, I should be able to assign a TODO item to another USER, so they can complete the task
As a USER, I should be able to see which USER completed a task so I can track status.
